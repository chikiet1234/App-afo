...
class ParentDo extends StatefulWidget {
  const ParentDo({super.key});

  @override
  State<ParentDo> createState() => _ParentDoState();
}
List<String> week =['Tuần 1', 'Tuần 2','Tuần 3','Tuần 4','Tuần 5'];
List<String> year =['2013 - 2014', '2014 - 2015','2015 - 2016','2016 - 2017','2017 - 2018'];

class _ParentDoState extends State<ParentDo> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        children: [
          AddCart.appBar(context, 'Parent do'),
          ...
          padingW(ynghia()),
          AddCart.spaceWidget(),
          Text('Những việc phụ huynh làm với bé', style: AddText.textColorH2(),textAlign: TextAlign.center,),
          AddCart.spaceWidget(),
          AddCart.cartViewItem(70, padingW(lam())),
  ...
  Column lam(){
    return Column(
      ...
      children: [
        Text('Thể loại: Kỹ năng sống', style: AddText.textNomal(),),
        Text('Tên: Lau nhà', style: AddText.textNomal(),),
      ],
    );
  }
}